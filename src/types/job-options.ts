...
/**
 * Long-form (human-readable) job-option fields. {@link EncodedJobOptions}
 * is the short-key form actually persisted on disk.
 */
...
/**
 * Persisted (short-key) job options. The keys are abbreviated for storage
 * compactness; {@link CompressableJobOptions} provides the human-readable
 * counterpart.
 */
export type EncodedJobOptions = BaseJobOptions & {
  /**
   * Debounce identifier.
   */
  deid?: string;
